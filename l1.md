...
# Caso de Estudio:
El caso de estudio que se trabajará en la materia es sobre un Sistema de Información Académico (SIA), se establecieron inicialmente los siguientes microservicios y lenguajes de programación:
- Estudiantes (Ruby).
- Materias (Java).
...
http://www.oracle.com/technetwork/java/javase/downloads/java-archive-javase8-2177648.html
  ...
  **c.** Descargar el conector de mysql para java la version 5.1.34
...
**5.** Crear tres archivos en la raíz del proyecto:
...
**7.** Ejecutar el archivo **./start.sh** para desplegar el microservicio
...
**12.** Para generar el model, ejecutar el siguiente comando:
...
**14.** Desplegar nuevamente el microservicio ejecutando ./start.sh.
...
**16.** Operación Get All Products. En Postman:   http://192.168.99.101:3000/students:
...
Verificamos que haya finalizado correctamente, en caso de no haber sido así verificar y corregir los errores que nos mostrará en consola.
...
**23.** Como paso final ejecutaremos el comando "docker-compose up" para que nos cree los contenedores en el nodo seleccionado
