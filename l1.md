...
**19.** En java se utilizará un modelo por capas, el código fuente se puede descargar del siguiente [enlace](./files/Java/).
...
**21.** Ejecutar el siguiente comando para la verificar el codigo fuente y crear del archivo **war**:
